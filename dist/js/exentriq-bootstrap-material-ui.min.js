...
EqUI.tabs.load()},$(document).ready(function(){Waves.init(),Waves.attach(".eq-ui-waves",["waves-effect"]),Waves.attach(".eq-ui-waves-light",["waves-effect","waves-light"]),$(window).resize(function(){_this.update()}),$(window).load(function(){_this.load()})})}(jQuery);